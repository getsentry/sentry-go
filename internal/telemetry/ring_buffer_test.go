...
func TestNewRingBuffer(t *testing.T) {
	t.Run("with valid capacity", func(t *testing.T) {
		buffer := NewRingBuffer[*testItem](ratelimit.CategoryError, 50, OverflowPolicyDropOldest, 1, 0, nil)
	...
	t.Run("with zero capacity", func(t *testing.T) {
		buffer := NewRingBuffer[*testItem](ratelimit.CategoryLog, 0, OverflowPolicyDropOldest, 1, 0, nil)
	...
	t.Run("with negative capacity", func(t *testing.T) {
		buffer := NewRingBuffer[*testItem](ratelimit.CategoryLog, -10, OverflowPolicyDropOldest, 1, 0, nil)
		if buffer.Capacity() != 100 {
			t.Errorf("Expected default capacity 100, got %d", buffer.Capacity())
		}
	})
...
func TestBufferBasicOperations(t *testing.T) {
	buffer := NewRingBuffer[*testItem](ratelimit.CategoryError, 3, OverflowPolicyDropOldest, 1, 0, nil)
...
func TestBufferOverflow(t *testing.T) {
	buffer := NewRingBuffer[*testItem](ratelimit.CategoryError, 2, OverflowPolicyDropOldest, 1, 0, nil)
...
func TestBufferDrain(t *testing.T) {
	buffer := NewRingBuffer[*testItem](ratelimit.CategoryError, 5, OverflowPolicyDropOldest, 1, 0, nil)
...
func TestBufferConcurrency(t *testing.T) {
	buffer := NewRingBuffer[*testItem](ratelimit.CategoryError, 100, OverflowPolicyDropOldest, 1, 0, nil)
...
func TestBufferDifferentCategories(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(string(tc.category), func(t *testing.T) {
			buffer := NewRingBuffer[*testItem](tc.category, 10, OverflowPolicyDropOldest, 1, 0, nil)
...
func TestBufferStressTest(t *testing.T) {
	...
	buffer := NewRingBuffer[*testItem](ratelimit.CategoryError, 1000, OverflowPolicyDropOldest, 1, 0, nil)
...
func TestOverflowPolicyDropNewest(t *testing.T) {
	buffer := NewRingBuffer[*testItem](ratelimit.CategoryError, 2, OverflowPolicyDropNewest, 1, 0, nil)
