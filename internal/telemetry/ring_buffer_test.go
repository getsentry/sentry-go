...
func TestNewRingBuffer(t *testing.T) {
	t.Run("with valid capacity", func(t *testing.T) {
		buffer := NewRingBuffer[*testItem](nil, ratelimit.CategoryError, 50, OverflowPolicyDropOldest, 1, 0)
	...
	t.Run("with zero capacity", func(t *testing.T) {
		buffer := NewRingBuffer[*testItem](nil, ratelimit.CategoryLog, 0, OverflowPolicyDropOldest, 1, 0)
	...
	t.Run("with negative capacity", func(t *testing.T) {
		buffer := NewRingBuffer[*testItem](nil, ratelimit.CategoryLog, -10, OverflowPolicyDropOldest, 1, 0)
		if buffer.Capacity() != 100 {
			t.Errorf("Expected default capacity 100, got %d", buffer.Capacity())
		}
	})
...
func TestBufferBasicOperations(t *testing.T) {
	buffer := NewRingBuffer[*testItem](nil, ratelimit.CategoryError, 3, OverflowPolicyDropOldest, 1, 0)
...
func TestBufferOverflow(t *testing.T) {
	buffer := NewRingBuffer[*testItem](nil, ratelimit.CategoryError, 2, OverflowPolicyDropOldest, 1, 0)
...
func TestBufferDrain(t *testing.T) {
	buffer := NewRingBuffer[*testItem](nil, ratelimit.CategoryError, 5, OverflowPolicyDropOldest, 1, 0)
...
func TestBufferConcurrency(t *testing.T) {
	buffer := NewRingBuffer[*testItem](nil, ratelimit.CategoryError, 100, OverflowPolicyDropOldest, 1, 0)
...
func TestBufferDifferentCategories(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(string(tc.category), func(t *testing.T) {
			buffer := NewRingBuffer[*testItem](nil, tc.category, 10, OverflowPolicyDropOldest, 1, 0)
...
func TestBufferStressTest(t *testing.T) {
	...
	buffer := NewRingBuffer[*testItem](nil, ratelimit.CategoryError, 1000, OverflowPolicyDropOldest, 1, 0)
...
func TestOverflowPolicyDropNewest(t *testing.T) {
	buffer := NewRingBuffer[*testItem](nil, ratelimit.CategoryError, 2, OverflowPolicyDropNewest, 1, 0)
...
func TestBufferIsReadyToFlush(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			buffer := NewRingBuffer[*testItem](nil, tt.category, 200, OverflowPolicyDropOldest, batchSize, timeout)
