...
func TestBucketedBufferPollOperation(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryError, 10, OverflowPolicyDropOldest, 3, 0, nil)
...
func TestBucketedBufferOverflowDropOldest(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryError, 3, OverflowPolicyDropOldest, 1, 0, nil)
	dropped := 0
...
func TestBucketedBufferPollIfReady_BatchSize(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryLog, 10, OverflowPolicyDropOldest, 3, 0, nil)
	for i := 1; i <= 3; i++ {
...
func TestBucketedBufferPollIfReady_Timeout(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryLog, 10, OverflowPolicyDropOldest, 100, 1*time.Millisecond, nil)
...
func TestNewBucketedBuffer(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryLog, 0, OverflowPolicyDropOldest, 0, -1, nil)
	if b.Capacity() != 100 {
...
func TestBucketedBufferBasicOperations(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryError, 10, OverflowPolicyDropOldest, 1, 0, nil)
...
func TestBucketedBufferPollBatchAcrossBuckets(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryError, 10, OverflowPolicyDropOldest, 10, 0, nil)
...
func TestBucketedBufferMetrics(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryError, 10, OverflowPolicyDropNewest, 1, 0, nil)
...
func TestBucketedBufferOverflowDropNewest(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryError, 2, OverflowPolicyDropNewest, 1, 0, nil)
	b.Offer(tbItem{id: 1})
	b.Offer(tbItem{id: 2})
...
func TestBucketedBufferClear(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryError, 5, OverflowPolicyDropOldest, 1, 0, nil)
	b.Offer(tbItem{id: 1})
	b.Offer(tbItem{id: 2})
	b.Clear()
	if !b.IsEmpty() || b.Size() != 0 {
...
func TestBucketedBufferIsReadyToFlush(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			b := NewBucketedBuffer[tbItem](tt.category, 10, OverflowPolicyDropOldest, batch, tt.timeout, nil)
...
func TestBucketedBufferConcurrency(t *testing.T) {
	b := NewBucketedBuffer[tbItem](ratelimit.CategoryError, 200, OverflowPolicyDropOldest, 1, 0, nil)
	const producers = 5
	const per = 50
