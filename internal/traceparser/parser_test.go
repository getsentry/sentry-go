...
func TestFrames(t *testing.T) {
	...
	for i := 0; i < traces.Length(); i++ {
		...
		output += fmt.Sprintf("Trace %d: goroutine %d with at most %d frames, created by goroutine %d\n", i, trace.GoID(), framesIter.LengthUpperBound(), trace.CreatedByGoID())
...
Trace 0: goroutine 7 with at most 2 frames, created by goroutine 6
  ...
  File = c:/dev/sentry-go/internal/traceparser/parser_test.go
  Line = 17
Trace 1: goroutine 1 with at most 6 frames, created by goroutine 0
  Func = testing.(*T).Run
  ...
  File = _testmain.go
  Line = 465
Trace 2: goroutine 6 with at most 4 frames, created by goroutine 0
  ...
  File = C:/Users/name/scoop/apps/go/current/src/testing/testing.go
  Line = 1629
Trace 3: goroutine 7 with at most 4 frames, created by goroutine 0
  Func = runtime.Stack
  ...
  File = c:/dev/sentry-go/profiler.go
  Line = 31
Trace 4: goroutine 19 with at most 2 frames, created by goroutine 0
