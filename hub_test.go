...
func (c *FakeClient) CaptureMessage(message string, hint *EventHint, scope EventModifier) {
	c.lastCall = "CaptureMessage"
	c.lastCallArgs = []interface{}{message, scope}
}

func (c *FakeClient) CaptureException(exception error, hint *EventHint, scope EventModifier) {
	c.lastCall = "CaptureException"
	c.lastCallArgs = []interface{}{exception, scope}
}

func (c *FakeClient) CaptureEvent(event *Event, hint *EventHint, scope EventModifier) {
