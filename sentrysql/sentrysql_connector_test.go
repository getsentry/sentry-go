		...
		}{
			{
				...
				WantSpan: &sentry.Span{
					Data: map[string]interface{}{
						...
						"db.namespace":   "fake",
						"db.query.text":  "SELECT | query_test | id | id = ?",
					},
		...
		}{
			{
				...
				WantSpan: &sentry.Span{
					Data: map[string]interface{}{
						"db.system.name": sentrysql.DatabaseSystem("fakedb"),
						"db.namespace":   "fake",
						"db.query.text":  "INSERT | exec_test | id = ?, name = ?",
					},
			...
			},
			{
				...
				WantSpan: &sentry.Span{
					Data: map[string]interface{}{
						"db.system.name": sentrysql.DatabaseSystem("fakedb"),
						"db.namespace":   "fake",
						"db.query.text":  "CREATE | temporary_test | id = int32, name = string",
					},
		...
		want := []*sentry.Span{
			{
				Data: map[string]interface{}{
					"db.system.name": sentrysql.DatabaseSystem("fakedb"),
					"db.namespace":   "fake",
					"db.query.text":  "SELECT | query_test | name | id = ?",
				},
		...
		tests := []struct {
			...
			},
			{
				...
				WantSpan: &sentry.Span{
					...
					Origin:      "manual",
					Sampled:     sentry.SampledTrue,
					Status:      sentry.SpanStatusUnimplemented,
				},
			},
		}
		...
		}{
			{
				...
				WantSpan: &sentry.Span{
					Data: map[string]interface{}{
						"db.system.name": sentrysql.DatabaseSystem("fakedb"),
						"db.namespace":   "fake",
						"db.query.text":  "SELECT | query_test | id, name, age | id = ?",
					},
